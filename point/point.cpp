...
public:
    ...
    void print() {//печать координат начала и конца отрезка
        cout << "Координаты точки P1:"; P1->printPoint();
        cout << "Координаты точки P2:"; P2->printPoint();
    }
    ...
    bool pointBelongs(point *P) {
        //возвращает true если точка P принадлежит отрезоку
    }
